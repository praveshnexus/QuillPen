...
import { Mail, Lock, Eye, EyeOff, Loader2, Feather } from "lucide-react";
...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setUser(meRes.data);
      toast.success(`Welcome back, ${meRes.data.name}!`, { icon: "👋", style: { fontWeight: "600" } });
        ...
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="rounded-3xl border border-slate-200/80 bg-white p-8 sm:p-10 shadow-xl shadow-slate-200/50">
            ...
            <p className="mt-2 text-center text-slate-500">
              Log in to your QuillPen account
            </p>
